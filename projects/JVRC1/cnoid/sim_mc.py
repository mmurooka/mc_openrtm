...
def connectMCControl():
    ...
    connectPorts(rh.port("resensor"), mc.port("RightElbowForceSensor"))
    connectPorts(rh.port("lksensor"), mc.port("LeftKneeForceSensor"))
    connectPorts(rh.port("backsensor"), mc.port("BackForceSensor"))
